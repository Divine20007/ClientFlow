...
export default function Dashboard() {
  ...
  return <main className="workspace"><header className="topbar"><div><span className="eyebrow">CLIENTFLOW</span><h1>Your workspace</h1><p>{email}</p></div><button className="secondary compact" onClick={logout}>Log out</button></header>
